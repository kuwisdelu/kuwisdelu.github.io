...
Fri Jan 17 | Introduction to tidyverse | R4DS "Tibbles", R4DS "Data transformation" | HW 1 due
Tue Jan 21 | Importing data, tidy and non-tidy data | R4DS "Data import", R4DS "Tidy data" | 
Fri Jan 24 | Exploratory data analysis | R4DS "Exploratory Data Analysis" | 
Tue Jan 28 | More data visualization + transformation | R4DS "Workflow: scripts", R4DS "Workflow: projects" | HW 2 due
Fri Jan 31 | Relational data in R, SQL | R4DS "Relational data" | 
Tue Feb 4 | *Review* |  |
Fri Feb 7 | *__Exam 1 - in class__* |  | HW 3 due, Project groups due
Tue Feb 11 | Databases with dbplyr | | 
Fri Feb 14 | Strings, factors, and date-times | R4DS "Strings", R4DS "Factors", R4DS "Dates and Times" | 
