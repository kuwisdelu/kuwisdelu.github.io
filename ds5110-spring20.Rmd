...
Fri Mar 13 | Machine learning using the *caret* package | [Documentation for the *caret* package](https://topepo.github.io/caret/) | HW 5 due |
Tue Mar 17 | Tidying text data and text mining | TMR, "Tidy text format", TMR "Analyzing word frequency", TMR "Relationships between words" | 
