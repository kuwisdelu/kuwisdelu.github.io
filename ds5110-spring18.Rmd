...
Fri Jan 26	| Importing data, tidy data | R4DS "Tibbles with tibble", R4DS "Data Import with readr", R4DS "Tidy data with tidyr" | HW1 due
Tue Jan 30	| Web scraping, tidying HTML and XML data |  | 
Fri Feb 02	| Relational data in R, SQL | R4DS "Relational data with dplyr" | 
Tue Feb 06	| Connecting to RDBMS's with dbplyr | | 
Fri Feb 09	| Data wrangling | R4DS "Strings with stringr", R4DS "Factors with forcats", R4DS "Dates and Times with lubridate" | HW2 due
Tue Feb 13	| Review for midterm exam |  | 
