...
Tue Mar 13	| *No class - Snow day* |  | 
Fri Mar 16	| Tidying text data and text mining in R | Supplementary reading: "Text mining with R" (https://www.tidytextmining.com) | 
Tue Mar 20	| Sentiment analysis and topic modeling in R | | 
Fri Mar 23	| Introduction to OOP in R, S3 versus S4 | AdvR "Functions", AdvR "OO field guide" | 
Tue Mar 27	| Building R packages, unit tests, reproducibility | Supplementary reading: "R packages" (http://r-pkgs.had.co.nz) | 
Fri Mar 30	| Working with big data in R |  | 
Tue Apr 03	| Parallelization and distributed computing in R |  | HW 3 due
