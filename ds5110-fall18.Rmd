...
Tue Sep 25	| Importing data, tidy data | R4DS "Tibbles with tibble", R4DS "Data Import with readr", R4DS "Tidy data with tidyr" | 
Fri Sep 28	| *Guest lecture - Web scraping, tidying HTML and XML data* |  | HW 1 due
Tue Oct 2	| Relational data in R, SQL | R4DS "Relational data with dplyr" |  | 
Fri Oct 5	| *No class* | 
Tue Oct 9	| Connecting to RDBMS's with dbplyr | | 
Fri Oct 12	| Data wrangling | R4DS "Strings with stringr", R4DS "Factors with forcats", R4DS "Dates and Times with lubridate" | 
Tue Oct 16	| Review for midterm exam |  | HW 2 due
...
Tue Oct 30	| Advanced modeling, cross-validation | R4DS "Many Models with purr and broom" | Project proposals due
...
Please let me know if you use a name or pronouns different from what appears the class roster. You may use a preferred name on Piazza and when submitting assignments and exams, but please be consistent and inform the instructors.
